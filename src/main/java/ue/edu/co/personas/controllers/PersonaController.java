...
public class PersonaController {
    ...
    private PersonaModel getPersona(PersonaModel oldData, PersonaModel newData) {
        oldData.setNombre(newData.getNombre());
        oldData.setEmail(newData.getEmail());
        oldData.setPrioridad(newData.getPrioridad());
        personaService.guardarPersona(oldData);
        return oldData;
    }
}